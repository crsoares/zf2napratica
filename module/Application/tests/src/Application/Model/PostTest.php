...
class PostTest extends ModelTestCase
{
	...
	public function testInputFilterInvalido()
	{
		...
		$post->title = 'Lorem Ipsum e simplesmente uma simulacao de texto da industria tipografica 
		e de impressos. Lorem Ipsum é simplesmente uma simulacao de texto da industriatipografica e de impressos';
	}
	...
	private function addPost()
	{
		...
		$post->post_data = date('Y-m-d H:i:s');
